...
export const LESSONS = [
  {
    ...
    prompts: [
      '请为“初中生学习小应用”生成 10 道四选一选择题（中文），主题：【我自己的主题】。每题包含：题目(q)、4个选项(choices)、正确答案(answer)。输出为 JSON 数组（外面用 [ ] 包住），方便我复制到 app.js 里。注意：choices 必须是 4 个字符串。answer 可以写“正确选项的内容”，也可以写字母 A/B/C/D。',
